        ...
        {data.length === 0 ? (
          ...
          <div>
            <div className="flex justify-end mb-4">
              ...
              <Link
                to="/admin-createUser"
                className="inline-block px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 mr-5 ml-5"
              >
                + ADD
              </Link>
            </div>
                  ...
                  .map((d, i) => (
                    <tr key={i}>
                      ...
                      <td className="border px-4 py-2 flex justify-center items-center space-x-2">
                        <Link
                          to={`/admin-update/${d.id}`}
                          className="inline-block px-2 py-1 bg-gray-500 text-white rounded hover:bg-gray-600 ml-2"
                        >
                          Edit
                        </Link>
                        <button
                          className="inline-block px-2 py-1 bg-red-500 text-white rounded hover:bg-red-600 ml-2"
